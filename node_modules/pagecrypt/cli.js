...
async function main() {
  ...
  const length = generatedLength ? parseInt(generatedLength) : void 0;
  const iterations = passwordIterations ? Number(passwordIterations) : void 0;
  if (iterations !== void 0 && !Number.isInteger(iterations)) {
  ...
  if (length) {
    ...
    console.log(`\u{1F510} Encrypting ${src} \u2192 ${dest}`);
